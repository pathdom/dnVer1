...
function getStampClass(statusText) {
  switch (statusText) {
    ...
    case 'Hủy': return 'stamp stamp-gray';
...
export default function StaffCustomersPage({ setCurrentPage, setSelectedCustomer }) {
              ...
              {loading ? (
                ...
                filtered.map((c) => (
                  <tr key={c.id} style={{ borderBottom: '1px solid var(--border)' }}>
                    ...
                    <td style={{ padding: '14px 16px', fontWeight: '600' }}>{c.country}</td>
