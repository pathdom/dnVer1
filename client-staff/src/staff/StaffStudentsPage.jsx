            ...
            <form onSubmit={handleFormSubmit} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div>
                  ...
                  <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="nam.nguyen@gmail.com" style={{ width: '100%', padding: '10px 14px', borderRadius: '16px', border: '1.5px solid var(--border)', fontSize: '13.5px' }} />
                </div>
              </div>
