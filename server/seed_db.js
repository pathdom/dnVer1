...
async function seedData() {
  try {
    ...
    await db.query(`
      ...
      VALUES
      ('HV-2451', 'Nguyễn Thị Lan Anh', 'lananh.nguyen@aladdin.vn', '0987654321', 'Hà Nội', 'Mỹ', 'Đã có visa', 'Cử nhân QTKD', '2026-09-01', 1, 120000000, 150000000, NOW()),
      ('HV-2453', 'Vũ Ngọc Mai', 'ngocmai.vu@aladdin.vn', '0976543210', 'Hải Phòng', 'Úc', 'Mới tiếp nhận', 'Cử nhân Thiết kế', '2026-10-15', 1, 30000000, 180000000, NOW()),
      ('HV-2456', 'Bùi Anh Tuấn', 'anhtuan.bui@aladdin.vn', '0965432109', 'Đà Nẵng', 'Đức', 'Tạm hoãn', 'Tiến sĩ Kỹ thuật PM', '2027-01-10', 2, 50000000, 220000000, NOW()),
      ('HV-2457', 'Trịnh Khánh Linh', 'khanhlinh.trinh@aladdin.vn', '0954321098', 'Cần Thơ', 'Hàn Quốc', 'Đang xử lý', 'Cử nhân Du lịch', '2026-11-01', 1, 45000000, 95000000, NOW()),
      ('HV-2458', 'Lý Minh Quân', 'minhquan.ly@aladdin.vn', '0943210987', 'Bình Dương', 'Mỹ', 'Đã nộp hồ sơ', 'Thạc sĩ Marketing', '2026-09-15', 2, 90000000, 160000000, NOW()),
      ('HV-2461', 'Trần Bảo Châu', 'baochau.tran@aladdin.vn', '0932109876', 'Quảng Ninh', 'Anh', 'Mới tiếp nhận', 'Cử nhân Truyền thông', '2026-10-01', 1, 20000000, 200000000, NOW())
